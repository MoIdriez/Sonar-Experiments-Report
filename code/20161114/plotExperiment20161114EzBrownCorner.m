datadir = 'D:\Git\Data\Experiments\20161114\EZ Brown\Corner\';
plotdir = 'C:\Users\p0079746\Documents\Sonar Experiments Report\plots\20161114\EZ Brown Corner\';
...
data = combinedata(strcat(datadir), 10, 1920, 10);
avg = mean(data);
f4 = figure;
hold on;
